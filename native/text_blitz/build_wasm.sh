...
# where the web app serves it (build/wasm/text_blitz.wasm, which the dev
# server exposes as /wasm/text_blitz.wasm). The web text
...
DEST="../../build/wasm/text_blitz.wasm"
cp -f "$SRC" "$DEST"
