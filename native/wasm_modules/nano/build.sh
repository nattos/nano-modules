...
_emit_spv_header_var sweep_chamber field_a field_b p_update trace stats prefill vs fs line_vs line_fs
echo "  sweep_chamber shaders compiled (SPV: field_a + field_b + p_update + trace + stats + prefill + vs + fs + lines)"
