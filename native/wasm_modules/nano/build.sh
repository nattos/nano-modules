...
_emit_spv_header_var lens prepare bokeh color geo blur16 extract hood sun glow finish
echo "  lens shaders compiled (SPV: prepare+bokeh+color+geo+blur16+extract+hood+sun+glow+finish)"
