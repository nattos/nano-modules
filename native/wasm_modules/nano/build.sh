...
_emit_spv_header_var triangulate downsample feature jfa_init jfa_splat jfa_step score_clear score seed_prep takeover present edge_clear edges line_vs line_fs
