...
static constexpr int kFontGlyphW = 8;
static constexpr int kFontGlyphH = 8;
static constexpr int kFontAtlasCols = 16;
static constexpr int kFontAtlasRows = 6; // ceil(96/16)
static constexpr int kFontAtlasW = kFontAtlasCols * kFontGlyphW; // 128
static constexpr int kFontAtlasH = kFontAtlasRows * kFontGlyphH; // 48
