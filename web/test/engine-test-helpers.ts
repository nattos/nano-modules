...
const LEGACY_MODULE_TO_EFFECT_ID: Record<string, string> = {
  'com.nano.spinningtris': 'debug.spinningtris',
  'com.nano.gpu_test': 'debug.gpu_test',
  'com.nano.brightness_contrast': 'color.tone.brightness_contrast',
  ...
  'color.tone.brightness_contrast': 'color.tone.brightness_contrast',
  'source.solid_color': 'source.solid_color',
  'mod.source.lfo': 'mod.source.lfo',
  'mod.shaper.remap': 'mod.shaper.remap',
  'mod.shaper.smooth': 'mod.shaper.smooth',
