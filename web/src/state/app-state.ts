...
export class AppState {
  ...
  public local: LocalState = {
    ...
    engine: { fps: 0, gpuTimeMs: 0, error: null, tracedFrames: {}, frameGeneration: 0, sketchState: {}, pluginStates: {}, modulationData: {}, debugConsoleLog: [], sidechannels: {}, scalarSidechannels: {}, triggerRails: {}, triggerChannels: {}, clipStates: {} },
    tappingMode: false,
    helpMode: false,
    selection: null,
    multiSelection: [],
